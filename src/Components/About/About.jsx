    ...
    return (
        <section className="about fl">
            <div className="contentAb w-60">
                ...
                <cite className="f5 ttu tracked fs-normal">―– Abraham Lincoln.</cite></h2>
                </blockquote>
            ...
            <div className="contentCo w-40">
                ...
                <h2 className="f5 f4-m f3-l lh-copy lh-title-m">Phone: +371 25630031</h2>
                <h2 className="f5 f4-m f3-l lh-copy lh-title-m"><a href="mailto:skmamman@outlook.com" style={{color:'rgba(2, 2, 95, 0.884)'}}>skmamman@outlook.com</a></h2>
                <div className="resume-button" data-aos="fade-up">
                <a className="f6 link grow dib v-mid br1 ph3 pv2 mb2 dib white bg-purple" 
                href="https://drive.google.com/file/d/1N0TMDrCiUQbn2owBHzB4lz4FNdCDAqhu/view?usp=sharing" target="blank">
                Download Resume</a>
                </div>
            </div>
        </section>
